...
public class Node{
	...
	public void calculateOutput()
	{
		...
		if(type==2 || type==4)//Not an input or bias node
		{
            ...
            // calculate sum of incoming w_i*x_i
            for (NodeWeightPair parent : parents) {
                input_sum += parent.weight * parent.node.getOutput();
            }
			// calculate sigmoid function over sum
            outputValue = 1.0/(1.0 + Math.exp(-input_sum));
		}
	}
